 ...
 */
@WebServlet("/culumAdd")
public class culumAdd extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Curriculum curriculum = new Curriculum(0,0,cuname,cuclassroom,cuclass,trueName,starttime,endtime,cuweek,cusection);
