        ...
        <form action="laboratoryAdd" method="post" >
            <table  border="1"  style="width: 80%; height: 80%; margin-left:100px;">
                <tr>
                    <td>教学楼</td>
                    <td>
                        <input type="text" name="lbuilding" value="">
                    </td>
                </tr>
                <tr>
                    <td>教室</td>
                    <td>
                        <input type="text" name="lclassroom" value="">
                    </td>
                </tr>
                <tr>
                    <td>人数：</td>
                    <td>
                        <input type="text" name="laccommodate" value="">
                    </td>
                </tr>
                ...
                <tr>
                    <td>备注：</td>
                    <td>
                         <textarea name="lremarks"  cols="30" rows="5"></textarea>
                    </td>
                </tr>
                <tr>
                    <td>教室状态：</td>
