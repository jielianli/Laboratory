        ...
        <c:forEach items="${requestScope.laboratorylist}" var="list">
            <tr>
                ...
                <td>
                    ...
                    <a href="deletelaboratory?lid=${list.lid}"  onclick="return window.confirm('是否确定删除？')">删除</a>
                </td>
            </tr>
        </c:forEach>
            <tr>
                <td  colspan="8" style="text-align: center" >
                    <a href="selectLaborad?pageNum=1">首页</a>
                    <a href="selectLaborad?pageNum=${p.pageNum>1 ? (p.pageNum-1) : 1}">上一页</a>
                    <a href="selectLaborad?pageNum=${p.pageNum<p.pageSum ? (p.pageNum+1) : p.pageSum}">下一页</a>
                    <a href="selectLaborad?pageNum=${p.pageSum}">尾页</a>
