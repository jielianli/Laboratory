...
<div class="layui-layout layui-layout-admin">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item" style="text-align: center">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="selectteacher?pageNum=1"  data-id="11" data-title="查看教师"
                               class="site-demo-active">
                ...
                <li class="layui-nav-item" style="text-align: center">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="selectculum?pageNum=1" data-url="https://www.xxx.com/" data-id="11" data-title="查看课程"
                               class="site-demo-active">
                ...
                <li class="layui-nav-item" style="text-align: center">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="selectLaborad?pageNum=1" data-url="https://www.xxx.com/" data-id="7" data-title="实验室详情"
                               class="site-demo-active">
                ...
                <li class="layui-nav-item" style="text-align: center">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="selectOrder?pageNum=1" data-url="https://www.xxx.com/" data-id="11" data-title="查看预约"
                               class="site-demo-active">
    ...
    <div class="layui-body"
        ...
        <%--<th width="10%">密码</th>--%>
        <%--</tr>--%>
        <%--<c:forEach items="${requestScope.admins}" var="u">--%>
        <%--<tr>--%>
        <%--<td>${u.aid}</td>--%>
        <%--<td>${u.aname}</td>--%>
        <%--<td>${u.apass}</td>--%>
