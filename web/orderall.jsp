            ...
            <c:forEach items="${requestScope.orderlist}" var="list">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="deleteorder?oid=${list.oid}"  onclick="return window.confirm('是否确定删除？')">删除</a>
                    </td>
                </tr>
            </c:forEach>
            <tr>
                <td  colspan="15" style="text-align: center" >
                    <a href="selectOrder?pageNum=1">首页</a>
                    <a href="selectOrder?pageNum=${p.pageNum>1 ? (p.pageNum-1) : 1}">上一页</a>
                    <a href="selectOrder?pageNum=${p.pageNum<p.pageSum ? (p.pageNum+1) : p.pageSum}">下一页</a>
                    <a href="selectOrder?pageNum=${p.pageSum}">尾页</a>
