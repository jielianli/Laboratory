        ...
        <form action="orderUpdate" method="post" >
            <table  border="1"  style="width: 80%; height: 80%; margin-left:100px;">
                <tr>
                    <td>教学楼</td>
                    <td>
                        <input type="hidden" name="oid" value="<%out.print(ordertable.getOid());%>">
                        <input type="hidden" name="tid" value="<%out.print(ordertable.getTid());%>">
                ...
                <tr>
                    <td>起始时间~~结束时间:</td>
                    <td>
                        <input type="hidden" name="orderDate" value="<%out.print(ordertable.getOrderDate());%>">
                        <input type="date" value="<%out.print(ordertable.getStarttime());%>" name="starttime">
                        ~~
                        <input type="date" value="<%out.print(ordertable.getEndtime());%>" name="endtime">
                    </td>
                </tr>
                <tr>
                    <td> 星期：</td>
                ...
                <tr>
                    <td>项目名称</td>
                    <td>
                        <input type="text" name="cuproject" value="<%out.print(ordertable.getCuproject());%>">
                    </td>
                </tr>
                <tr>
                    <td>班级</td>
                    <td>
                        <input type="text" name="cuclass" value="<%out.print(ordertable.getCuclass());%>">
                    </td>
                </tr>
                <tr>
                    <td>人数</td>
                    <td>
                        <input type="text" name="cunumber" value="<%out.print(ordertable.getCunumber());%>">
                    </td>
                </tr>
                <tr>
                    <td>描述</td>
