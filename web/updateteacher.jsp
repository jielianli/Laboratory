            ...
            <table  border="1"  style="width: 80%; height: 80%; margin-left:100px;">
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="tname" value="<%out.print(t.getTname());%>">
                    </td>
                </tr>
                <tr>
                    <td>密码</td>
                    <td>
                        <input type="text" name="tpass" value="<%out.print(t.getTpass());%>">
                    </td>
                </tr>
                <tr>
                    <td>姓名</td>
                    <td>
                        <input type="text" name="trueName" value="<%out.print(t.getTrueName());%>">
                    </td>
                </tr>
                ...
                <tr>
                    <td>院系</td>
                    <td>
                        <input type="text" name="tdepartment" value="<%out.print(t.getTdepartment());%>">
                    </td>
                </tr>
                <tr>
                    <td>联系方式</td>
                    <td>
                        <input type="text" name="contact" value="<%out.print(t.getContact());%>">
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
